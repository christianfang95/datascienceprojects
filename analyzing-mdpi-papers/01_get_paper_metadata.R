...
#Take a 10% random sample of each data frame. 


samp_2017 <- papers_2017 |> 
  slice_sample(prop=.10) |> 
  add_column(recorddate='2017')

samp_2018 <- rbindlist(list(papers_2018, papers_2018b, 
                            papers_2018c, papers_2018d, papers_2018e, 
                            papers_2018f, papers_2018g, papers_2018h )) |>
  slice_sample(prop=.10) |>
  add_column(recorddate='2018')

samp_2019 <- rbindlist(list(papers_2019a, papers_2019b, papers_2019c, 
                            papers_2019d, papers_2019e, papers_2019f, 
                            papers_2019g, papers_2019h, papers_2019i, 
                            papers_2019j, papers_2019k, papers_2019l)) |>
  slice_sample(prop=.10) |>
  add_column(recorddate='2019')

samp_2020 <- rbindlist(list(papers_2020a, papers_2020b, papers_2020c,
                            papers_2020d, papers_2020e, papers_2020f,
                            papers_2020g, papers_2020h, papers_2020i,
                            papers_2020j, papers_2020k, papers_2020l)) |>
  slice_sample(prop=.10) |>
  add_column(recorddate='2020')


samp_2021 <- rbindlist(list(papers_2021a, papers_2021b, papers_2021c,
                            papers_2021d, papers_2021e, papers_2021f,
                            papers_2021g, papers_2021h, papers_2021i,
                            papers_2021j, papers_2021k, papers_2021l,
                            papers_2021m, papers_2021n, papers_2021o,
                            papers_2021p, papers_2021q, papers_2021r,
                            papers_2021s, papers_2021v, papers_2021w,
                            papers_2021x, papers_2021y)) |>
  slice_sample(prop=.10) |>
  add_column(recorddate='2021')

samp_2022 <- rbindlist(list(papers_2022a, papers_2022b, papers_2022c,
                            papers_2022d, papers_2022e, papers_2022f,
                            papers_2022g, papers_2022h, papers_2022i)) |>
  slice_sample(prop=.10) |>
  add_column(recorddate='2022')

final_sample <- rbindlist(list(papers_2014, papers_2015, papers_2016,
                               samp_2017, samp_2018, samp_2019, 
                               samp_2020, samp_2021, samp_2022), fill=TRUE)
